...
// =====================================================
// Recommendations Type ("send this to a friend")
// =====================================================

// A snapshot of the sender's media row at send-time, not a live reference -
// see the recommendations table's comment in supabase/schema.sql.
...
// An inbox row, annotated with who sent it (resolved server-side, same as
// FriendshipWithProfile - the client can't look up Clerk users directly).
