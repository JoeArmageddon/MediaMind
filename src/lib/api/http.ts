// Shared timeout/retry helpers for API clients. Previously reimplemented
// slightly differently in src/lib/api/search.ts, src/lib/db/dexie.ts (a
// simpler timeout-only variant), and src/lib/api/jikan.ts (hand-rolled
// rate-limit/backoff) - this is the one place API clients that need
// timeout/retry protection should pull it from.
